...
function updateSlider() {
  ...
  // Idem pour le texte (innerHTML car la propriété permet à une chaîne de caractères JavaScript 
  //d'être interprété par le navigateur comme du code HTML et que nous avons ici la présence
  // des balises <p>)
